...
#define VIRTUAL_CB_SIZE 0x9C400	// 2014.10.19 A

#define MESSAGE_STRING_BUFFER_SIZE pow(1024,2)
...
int AllocMessageStringBuffer(bool AllocateBuffer)
{
	int i, r, flg;
	TCHAR *ptr, *p;
	TCHAR* MessageStringBuffer = NULL;

	if (!AllocateBuffer) free(MessageStringBuffer);
