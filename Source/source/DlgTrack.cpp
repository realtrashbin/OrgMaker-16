...
void LoadTrackBitmaps(HWND hdwnd) {
	...
	//Drams
	LoadSingleBitmap(hdwnd, IDC_TRACKDxQ, 14, 21, "B_TRACK_Q");
	LoadSingleBitmap(hdwnd, IDC_TRACKDxW, 14, 21, "B_TRACK_W");
	...
	LoadSingleBitmap(hdwnd, IDC_TRACKDxA, 14, 21, "B_TRACK_A");
	LoadSingleBitmap(hdwnd, IDC_TRACKDxS, 14, 21, "B_TRACK_S");
	LoadSingleBitmap(hdwnd, IDC_TRACKDxD, 14, 21, "B_TRACK_D");
	LoadSingleBitmap(hdwnd, IDC_TRACKDxF, 14, 21, "B_TRACK_F");
	LoadSingleBitmap(hdwnd, IDC_TRACKDxG, 14, 21, "B_TRACK_G");
	LoadSingleBitmap(hdwnd, IDC_TRACKDxH, 14, 21, "B_TRACK_H");
	LoadSingleBitmap(hdwnd, IDC_TRACKDxJ, 14, 21, "B_TRACK_J");
	LoadSingleBitmap(hdwnd, IDC_TRACKDxK, 14, 21, "B_TRACK_K");
}
